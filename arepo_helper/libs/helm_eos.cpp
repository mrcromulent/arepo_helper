...
static inline double h5(const double fi[36], double w0t, double w1t, double w2t, double w0mt, double w1mt, double w2mt, double w0d, double w1d, double w2d, double w0md, double w1md, double w2md) {
...
static inline double h3(const double fi[16], double w0t, double w1t, double w0mt, double w1mt, double w0d, double w1d, double w0md, double w1md) {
...
static inline void azbar(t_helm_eos_table* helm_eos_table, const double xnuc[], double *abar, double *zbar) {
...
// electron-positron
static int __attribute__((unused)) helm_eos_ele(t_helm_eos_table* helm_eos_table, double rho, double temp, double l10temp, double pele[5], double eele[5], double sele[5], double etaele[5], double xne[5], const struct helm_eos_cache *cache, const int only_e) {
