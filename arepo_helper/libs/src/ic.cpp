...
PyObject* _createWhiteDwarfHe(PyObject *self, PyObject *args) {
    ...
    dict = PyDict_New();
    PyDict_SetStolenItem( dict, "rho", (PyObject*)create_numpy_array( rho, i ) );
    PyDict_SetStolenItem( dict, "u", (PyObject*)create_numpy_array( e, i ) );
    PyDict_SetStolenItem( dict, "p", (PyObject*)create_numpy_array( p, i ) );
    PyDict_SetStolenItem( dict, "dm", (PyObject*)create_numpy_array( dm, i ) );
    PyDict_SetStolenItem( dict, "r", (PyObject*)create_numpy_array( r, i ) );
