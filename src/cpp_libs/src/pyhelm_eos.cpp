...
PyObject* pyHelmEos_tgivenfull(pyHelmEos* self, PyObject* args) {
    ...
    PyDict_SetStolenItem(dict, "dpdRho", (PyObject*)PyFloat_FromDouble(res.p.drho));
...
PyObject* pyHelmEos_egivenfull(pyHelmEos* self, PyObject* args) {
    ...
    temp = -1;
    if (!PyArg_ParseTuple(args, "dO!d|d:helmeos.egivenfull(rho, xnuc, e, [temp])", &rho, &PyArray_Type, &pyXnuc, &e, &temp)) {
        return nullptr;
    }
