...
class ArepoRun:
    ...
    num_snapshots: int = 0
    snapbase: Optional[str] = None
    target_dir: Optional[str] = None
    cachedir: str = "areporun_cache"

    run_header: Dict[str, float] = dict()
    maxima: Dict[str, List[float]] = dict()
    minima: Dict[str, List[float]] = dict()
    ...
    def get_particle_lifetimes(self,
                               pids_requested: list[int],
                               fields: Optional[list[str]] = None) -> List[Dict[str, np.ndarray]]:
