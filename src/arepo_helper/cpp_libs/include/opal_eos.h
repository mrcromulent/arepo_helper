...
#ifndef AREPO_HELPER_LIBS_OPAL_EOS_H
#define AREPO_HELPER_LIBS_OPAL_EOS_H
...
struct opal_eos_result {
    ...
    double rho;    /**< density in g/cm^3, needed for ptgiven functions  */
};
...
#define opaleos_all_ptgiven opaleos_all_ptgiven_global
#define opaleos_ptgiven opaleos_ptgiven_global
#else
...
#define opaleos_all_ptgiven opaleos_all_ptgiven_local
#define opaleos_ptgiven opaleos_ptgiven_local
#endif



#endif //AREPO_HELPER_LIBS_OPAL_EOS_H
